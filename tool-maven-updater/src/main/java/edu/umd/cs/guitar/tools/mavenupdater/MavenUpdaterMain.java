...
public class MavenUpdaterMain {
	...
	public static void main(String[] args) throws Exception {
		...
		String workspace_root = "/Users/bryan/code/withBryan/guitar/";
		String pom = workspace_root + "pom.xml";
		...
		try {
		    ...
		    for (String module : model.getModules()){
				...
				SVNURL source_loc = SVNURL.create("http", "bryantrobbins", "svn.code.sf.net", 80, "/p/guitar/code/trunk/modules/" + module, false);
