...
/**
 * Like {@link edu.berkeley.nlp.lm.io.MakeLmBinaryFromGoogle}, except it only writes the NgramMap
 ...
 * {@link edu.berkeley.nlp.lm.io.LmReaders#readGoogleLmBinary(String, edu.berkeley.nlp.lm.WordIndexer, String)}
 * 
 * @author adampauls
 * 
 */
