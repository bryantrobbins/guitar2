 ...
 * 
 * Confusingly, this class is both a {@link edu.berkeley.nlp.lm.io.LmReaderCallback} (called from
 * {@link edu.berkeley.nlp.lm.io.TextReader}, which reads plain text), and a {@link edu.berkeley.nlp.lm.io.LmReader}, which
 * "reads" counts and produces Kneser-Ney probabilities and backoffs and passes
 * them on an {@link edu.berkeley.nlp.lm.io.ArpaLmReaderCallback}
 * 
 * @author adampauls
 * 
 * @param <W>
