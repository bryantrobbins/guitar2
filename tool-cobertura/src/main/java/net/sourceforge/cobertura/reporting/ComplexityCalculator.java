...
public class ComplexityCalculator {
	...
	/**
	 * Creates new calculator. Passed {@link net.sourceforge.cobertura.util.FileFinder} will be used to
	 * map source file names to existing files when needed. 
	 * 
	 * @param finder {@link net.sourceforge.cobertura.util.FileFinder} that allows to find source files
