...
import net.sourceforge.cobertura.reporting.xml.XMLReportExtend;
import net.sourceforge.cobertura.reporting.xml.XMLReportExtendBranch;
...
public class Main {
	...
	private void parseArguments(String[] args) throws Exception {
		...
		}  else if (format.equalsIgnoreCase("extXml")) {
			new XMLReportExtend(projectData, destinationDir, finder, complexity);
		}  else if (format.equalsIgnoreCase("extXmlBranch")) {
			new XMLReportExtendBranch(projectData, destinationDir, finder, complexity);
		}
	}
	...
	private void setFormat(String value) 
	{
		...
		if (!format.equalsIgnoreCase("html") 
				...
				&& !format.equalsIgnoreCase("extXml")
				&& !format.equalsIgnoreCase("extXmlBranch")
				) {
			System.err.println("" +
					"Error: format \"" +
					format + "\" is invalid. Must be either html or xml or summaryXml or extXml"
					);
			System.exit(1);
		}
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Modified by baonn@cs.umd.edu to get more coverage data");
