 ...
 * - {@link #readFile(String) readFile}<br>
 * - {@link #concatPath(String, String) concatPath}<br>
 *
 * Other less frequently used but still handy methods are:<br>
 * - {@link #normalizeFileName(String) normalizeFileName} to take the current user directory into account via the 'user.dir' system property<br>
 *
